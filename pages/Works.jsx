  ...
  return (
      <div className="pb-36 text-white md:ml-20  ">
            ...
            >
              ...
              <div className="relative w-full md:w-1/2 lg:w-1/3 ">
                <img
                  src={cert.image}
                  alt="Certification"
                  className="w-full object-cover md:-mr-10 
                  lg:-mr-16"
                />
              </div>
              ...
              md:w-1/2 lg:w-2/3 z-10 text-gray-600">
        ...
        <div className="text-center mt-[40px] gap-y-7 flex flex-col items-center">
          ...
          <p className="text-gray-400 text-base max-w-[550px]">For some 
            of my other projects and infrastructures I've that ive had the 
            opportunity to work on, you can find them on my github.</p>
            <a href="https://github.com/codecamp-web"><FaGithub fontSize={30}  /></a>
        </div>
      </div>
  );
};
